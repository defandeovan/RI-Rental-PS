...
class _KelolaUnitPageState extends State<KelolaUnitPage> {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildDrawerItem(Icons.videogame_asset, 'Daftar Unit PS', true, () {}),
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  icon: const Icon(Icons.edit, size: 18, color: Color(0xFF2D2D2D)),
                  label: const Text(
                    'edit',
                    style: TextStyle(
                      color: Color(0xFF2D2D2D),
  ...
  void _showEditUnitDialog(Map<String, dynamic> unit) {
    ...
    final TextEditingController typeController = TextEditingController(text: unit['type']);
    final TextEditingController priceController = TextEditingController(text: unit['price']);
